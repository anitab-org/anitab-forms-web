...
class Register extends Component {
    constructor(props){
        ...
        this.state = {
            ...
            submitted: false,
            emailregexp: /\S+@\S+\.\S+/,
            passwordregexp: /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[-~`!@#$%^&*()_+=><,.|?/\\{}\[\]"':;])[A-Za-z\d-~`!@#$%^&*()_+=><,.|?/\\{}\[\]"':;]{12,}$/
        };
    ...
    render() {
        ...
        var usererror=null
        var mailerror = null
        this.props.registererror ? usererror=this.props.registererror.username : usererror=null
        this.props.registererror ? mailerror=this.props.registererror.email : mailerror= null
                    ...
                    <Divider />
                        ...
                        }
                        {
                            this.state.error && this.state.submitted ?
                                ...
                                <Message
                                warning
                                content='Email address not valid.'
                                />
                                : null
                            : null
                        }
