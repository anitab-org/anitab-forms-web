...
import {
  getUnpublishedForm,
  deleteUnpublishedForm,
  publishForm,
  patchUnpublishedForm,
} from '../actions/form';
            ...
            unpublishedform.map((unpublishedform) => (
              <Card fluid key={unpublishedform.id}>
                    ...
                    <div className="details">
                      <div className="first">
                        ...
                        <span>
                          Fields:{' '}
                          <span className="blue">
                            {unpublishedform.questions.length}
                          </span>
                        </span>
                      </div>
                      <div className="center">
                        <span>
                          Target User:{' '}
                          <span className="blue">
                            {unpublishedform.target_user.toUpperCase()}
                          </span>
                        </span>
                      </div>
                      <div className="last">
                        <span>
                          ...
                          <span className="grey">
                            {moment(
                              new Date(unpublishedform.created_on),
                              'YYYYMMDD'
                            ).fromNow()}
                          </span>
                        </span>
                        <span>
                          ...
                          <span className="grey">
                            {moment(
                              new Date(unpublishedform.updated_on),
                              'YYYYMMDD'
                            ).fromNow()}
                          </span>
                        </span>
                ...
                <Card.Content extra>
                  <Button
                    color="green"
                    onClick={(event) => this.publish(event, unpublishedform.id)}
                  >
                    PUBLISH
                  </Button>
                  <Modal
                    ...
                    <Modal.Content>
                      <Form>
                        ...
                        <div className="button">
                          ...
                          <Form.Button
                            onClick={(event) =>
                              this.updateForm(event, unpublishedform.id)
                            }
                            color="green"
                          >
                            SUBMIT
                  ...
                  >
                    ...
                    <Modal.Actions>
                      ...
                      <Button
                        color="green"
                        onClick={(event) =>
                          this.deleteForm(event, unpublishedform.id)
                        }
                      >
                  ...
                  <Button
                    ...
                    labelPosition="right"
                    as={Link}
                    to={form(unpublishedform.id, 'False')}
                  >
