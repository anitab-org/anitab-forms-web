  ...
  switch (action.type) {
    ...
    case POST_FORM:
      return {
        ...
        publishedform: action.payload.published_status
          ? [action.payload, ...state.publishedform]
          : [...state.publishedform],
        unpublishedform: action.payload.published_status
          ? [...state.unpublishedform]
          : [action.payload, ...state.unpublishedform],
      };
